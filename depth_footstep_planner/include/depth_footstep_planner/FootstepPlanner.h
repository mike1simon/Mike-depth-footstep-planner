...
#ifndef DEPTH_FOOTSTEP_PLANNER_FOOTSTEPPLANNER_H_
#define DEPTH_FOOTSTEP_PLANNER_FOOTSTEPPLANNER_H_
...
public:
   ...
   */
  bool setGoal(State left_foot, State right_foot);
   ...
   * @return True if the two foot poses have been set successfully.
   */
  bool setStart(State left_foot, State right_foot);
...
protected:
  ...
  void updateEnvironment(const depthmap2d::DepthMap2DPtr old_map);
...
#endif  // DEPTH_FOOTSTEP_PLANNER_FOOTSTEPPLANNER_H_
